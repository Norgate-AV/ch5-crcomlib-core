...
UPSTREAM_NPM_PACKAGE_SITE=https://www.npmjs.com/package/${UPSTREAM_NPM_PACKAGE}
...
if [[ "${GITHUB_ENV}" ]]; then
    ...
    echo "UPSTREAM_NPM_PACKAGE_SITE=${UPSTREAM_NPM_PACKAGE_SITE}" >>"${GITHUB_ENV}"
...
export UPSTREAM_NPM_PACKAGE_SITE
